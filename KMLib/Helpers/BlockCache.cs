/*
 * Modified class based on LibSVM and SVM.net libraries
 * 
 * 
 */ 
using System;
...
namespace KMLib.Helpers
{
    ...
    internal class BlockCache
    {
        ...
        {
            public head_t(BlockCache enclosingInstance)
            {
                _enclosingInstance = enclosingInstance;
            }
            private BlockCache _enclosingInstance;
            public BlockCache EnclosingInstance
            {
                get
                {
        ...
        /// Kernel cache
        /// </summary>
        /// <param name="count">is the number of total data items</param>
        /// <param name="size">is the cache size limit in bytes</param>
        public BlockCache(int count, long size)
        {
            _count = count;
            _size = size;
