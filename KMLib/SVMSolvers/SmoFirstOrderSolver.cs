...
namespace KMLib.SVMSolvers
{
    ...
    public class SmoFirstOrderSolver<TProblemElement> : Solver<TProblemElement>
    {
        ...
        public SmoFirstOrderSolver(Problem<TProblemElement> problem, IKernel<TProblemElement> kernel, float C)
